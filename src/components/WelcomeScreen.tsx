    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={onStart}
          className="w-full max-w-[280px] py-4 px-6 bg-[#1D1D1F] hover:bg-[#000000] active:scale-[0.98] text-white font-bold text-lg rounded-2xl shadow-xl transition-all flex items-center justify-center gap-3 font-display tracking-wide cursor-pointer"
        >
          <span>LET&apos;S GO</span>
