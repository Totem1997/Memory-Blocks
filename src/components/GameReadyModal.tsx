    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-sm bg-[#FAF7F2] rounded-3xl p-8 shadow-2xl overflow-hidden flex flex-col items-center text-center"
        >
          ...
          <h2 className="text-2xl font-black text-[#2D2A26] font-display mb-4">
            Everything is set!
          </h2>
          
          <div className="space-y-4 text-[#6D655E] text-base leading-relaxed mb-8">
            <p>
          ...
          <button
            onClick={onClose}
            className="w-full py-4 px-6 bg-[#2D2A26] hover:bg-[#1A1816] active:scale-[0.98] text-white font-bold text-lg rounded-2xl shadow-xl transition-all flex items-center justify-center gap-2 font-display tracking-wide cursor-pointer"
          >
            <span>PLAY NOW</span>
