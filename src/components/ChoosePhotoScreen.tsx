        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-[#515154] text-lg max-w-sm mx-auto mb-10 leading-relaxed">
              Take a moment to find a memory that always makes you smile. It can be a photo with the person who gave you this, a family or friends photo, your favorite cute pet photo, or any photo that really inspires you, and let's turn it into something fun.
            </p>
